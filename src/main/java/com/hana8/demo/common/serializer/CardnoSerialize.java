...
public class CardnoSerialize extends StdSerializer<String> {
	protected CardnoSerialize() {
		super(String.class);
	}
	...
	private String format(String card) {
		return card.replaceAll("(\\d{4})(\\d{2})(\\d{2})(\\d{4})(\\d{4})", "$1-$2**-****-$5");
	}
}
